...
import com.files.utilities.Common;
import com.files.utilities.Output;
import com.files.utilities.Xls_Reader;
...
public class TestBase extends Common {
	...
	public void Initialize() throws Exception { 
		...
		if (!isInitialized) {
			...
			FileInputStream ip = new FileInputStream("./src/main/java/com/files/logs/config.properties");
			CONFIG.load(ip);
			APP_LOGS.debug("config.properties Files Loaded Sucessfully :");

			//xls file
			APP_LOGS.debug("Proceed to start Loading XLS Files :");
			Sprint1xls = new Xls_Reader("./src/main/java/com/files/xls/Sprint_1.xlsx");
			suiteXls  = new Xls_Reader("./src/main/java/com/files/xls/Suite.xlsx");

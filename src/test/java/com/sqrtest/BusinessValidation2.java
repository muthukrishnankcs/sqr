...
@Test(groups={ "myGroup1", "myGroup2"})
public class BusinessValidation2 extends DatabaseUtils {
    ...
    @Parameters({"query"})
    public void fetchEIDLessThan100(@Optional("select eid,name,salary from employee where salary<100;") String query) throws SQLException{
        getConnection();
        ResultSet r = getResultSet(query);
        while(r.next()) {
